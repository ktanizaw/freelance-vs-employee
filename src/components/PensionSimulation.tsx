...
export function PensionSimulation({ data }: PensionSimulationProps) {
  ...
  return (
    <div className="mt-8 bg-amber-50 border border-amber-200 rounded-xl p-4 sm:p-6">
      <h3 className="text-sm sm:text-base font-bold text-amber-900 mb-1 flex items-center">
        年金シミュレーション（参考）
        ...
        <table className="w-full text-xs sm:text-sm">
          <thead>
            <tr className="border-b border-amber-300">
              <th className="text-left py-2 pr-2 sm:pr-4 text-amber-800 font-semibold" />
          ...
          <tbody className="text-gray-700">
            ...
            <tr>
              <td className="py-2 pr-2 sm:pr-4 font-semibold text-amber-900">受給額の差／年</td>
              <td colSpan={2} className="text-right py-2 pl-1 sm:pl-4 font-mono font-bold text-amber-900">
